...
static const Rule rules[] = {
    ...
    {"Rustdesk",                  NULL,         NULL,     1 << 5,       0,           -1         0,0,0,0         NULL },
    {NULL,                        "keepassxc",  NULL,     SPTAG(0),     0,           -1         0,0,0,0         NULL },
    {"st-floating",               "spterm",     NULL,     SPTAG(1),     1,           -1         50,50,500,500         NULL },
    {"st-floating",               "spfm",       NULL,     SPTAG(2),     1,           -1         50,50,500,500         NULL },
    {"Lehte",                     NULL,         NULL,     0,            1,           -1         50,50,500,500         NULL },
    {"satty",                     NULL,         NULL,     0,            1,           -1         50,50,500,500         NULL },
    {"Display",                   NULL,         NULL,     0,            1,           -1         50,50, 0, 0, 1},
    {"matplotlib",                NULL,         NULL,     0,            1,           -1         50,50,500,500         NULL },
};
